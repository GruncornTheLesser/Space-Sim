...
namespace DeepCopy
{
    ...
    // Ive set up the deep copies using delegates/Func/Action which are pretty much function pointers
    ...
    class DeepCopy<T> : IDeepCopy where T : new()
    {
        ...
        /// <param name="setter">The function to set the parameter. The set function must take one value of type T. eg '(value) => parameter = value'. </param>
